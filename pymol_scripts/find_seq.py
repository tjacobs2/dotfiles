...
def find_seq(needle, haystack, selName=None, het=0, firstOnly=0):
	"""
	DESCRIPTION:
	...
	USAGE:
	find_seq needle, haystack[, selName[, het[, firstOnly]]]
	...
	IDs = map( lambda x: int(re.search('\d+', x[0]).group(0)), aaDict['aaList'] )
